...
export const Home = () => {
  return (
    <div className="flex flex-col justify-between min-h-screen bg-gradient-to-r bg-slate-900 text-slate-400 font-RobotoMono">
      <Navbar />
      <section className="flex flex-col justify-center  md:pt-20 lg:pt-40 items-center text-center gap-10 leading-10 h-[90%] lg:flex-row lg:text-left lg:items-start">
